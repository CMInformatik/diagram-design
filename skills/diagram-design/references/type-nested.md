...
- Each level labeled at the top-left in Roboto Mono eyebrow style (7–8px, letter-spacing 0.14em). Labels sit on a paper-colored mask rect over the ring's top border.
...
- Italic Arial callouts (see `references/primitive-annotation.md`) — 1–2 max.
