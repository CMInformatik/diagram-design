...
- Each layer has:
  - **Name label** centered inside the trapezoid — Arial 12–14px 600.
  - **Sublabel** below or beside the name — Roboto Mono 9–10px.
...
- Optional left-margin axis arrow + Roboto Mono label (`rarer ↑`, `drop-off ↓`).
